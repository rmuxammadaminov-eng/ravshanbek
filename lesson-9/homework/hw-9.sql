...
-- Create Products table with a foreign key reference
...
-- Insert sample suppliers (assuming 5 suppliers based on your data)
...
-- Insert product data
INSERT INTO Products11 (ProductID, ProductName, Price, Category, StockQuantity, SupplierID) VALUES
...
CROSS JOIN 
    ...
    HireDate DATE,
    ManagerID INT,
    FOREIGN KEY (ManagerID) REFERENCES Employees11(EmployeeID)
);

INSERT INTO Employees11 (EmployeeID, Name, DepartmentID, Salary, HireDate, ManagerID) VALUES
...
select a.name,b.coursename from Students a cross join Courses b
...
FROM
    Employees e1
JOIN
    Employees e2 ON e1.EmployeeID < e2.EmployeeID  -- avoid duplicates and self-pairing
WHERE
